---
title: "R Code Style Tips for This Course"
format: html
...
[Adapted from the Tidyverse's style guide](https://style.tidyverse.org/)
...
- You can add newlines after operators (e.g., `<-`, `=`, `+`), after commas (`,`) or opening parentheses (`(`, `{`).
- Google collab will draw a margin when you are close to the 80 character mark.
...
``` r
# 137 characters
potion_result <- brew_potion(ingredient1 = "dragon_scales", ingredient2 = "unicorn_hair", temperature = 666, stirring_speed = "vigorous")
```
:::
...
::: {.callout-tip icon="false"}
``` r
potion_result <- brew_potion(
  ingredient1 = "dragon_scales",
  ingredient2 = "unicorn_hair",
  temperature = 666,
  stirring_speed = "vigorous"
)
```
:::
